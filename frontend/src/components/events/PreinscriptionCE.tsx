...
export const PreInscription = () => {
  ...
  const [hasTeam, setHasTeam] = useState<boolean | string>(false);
      ...
      {hasTeam ? (
        <div>
          {hasTeam === true ? (
            ...
            <div>
              <p>
                Tu ne peux pas inscrire une équipe car tu as déjà une équipe
                assignée
              </p>
          ...
          <p>
            Si il y a un problème avec ton équipe, contacte les administrateurs
            !
          </p>
        </div>
      ) : (
        <div>
          <p id="desc-preinsc">
            Inscris ton équipe pour la préinscription en choisissant un nom
            d'équipe temporaire, puis en ajoutant tes coéquipiers (tu seras
            automatiquement ajouté à l'équipe). Tu peux inscrire 3 ou 4
            coéquipiers.
          </p>
          <input
            className="event-input"
            type="text"
            placeholder="Nom provisoire de l'équipe"
            onChange={(e) => {
