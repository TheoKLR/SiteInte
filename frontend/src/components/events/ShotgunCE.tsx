...
export const ShotgunCE = () => {
    ...
    const handleSubmit = async () => {
        if(answer === "T'as les cramptés?") {
            ...
            await handleError("Bien joué", "Mauvaise saisie", setTimestamp, timestamp, currentUserTeamId )
            setSuccess(true);
        } else {
        ...
        <>
            <div className='containerChoix'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="text" placeholder="Phrase magique" autoComplete="off" onChange={(e) => setAnswer(e.target.value)} value={answer} required />
                    <button className="button-36" type="submit">Envoyer</button>
